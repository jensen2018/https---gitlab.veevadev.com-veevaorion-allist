...
@custom_advanced_field_factory.register('speaker_cs_doctor_level_speaker')
class DoctorLevelSpeaker(object):
    ...
    def get_record_data(self, record_id):
        ...
        # 获取讲者对应的医生id
        professional_id = models.Speakers.objects.filter(id=record_id).values_list('professional_id', flat=True)[0]
        ...
        if record_id:
            ...
            with connection.cursor() as cursor:
                product_level_sql = """
                    ...
                    left join speakers s on pm.professional_id = s.professional_id
...
@custom_advanced_list_field_factory.register('speaker_cs_doctor_level_speaker')
class DoctorLevelSpeaker(object):
    ...
    def get_record_data(self, record_ids):
        ...
        # 获取讲者对应的医生id
        professional_ids = models.Speakers.objects.filter(id__in=record_ids).values_list('professional_id', flat=True)
